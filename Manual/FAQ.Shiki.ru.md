...
- _Где вообще Shiki?_  
Shiki сейчас часть [WhateverGreen](https://github.com/devicemanager/WhateverGreen)
...
- _Как мне изменить MAC адрес сетевой карты с помощью [libHookMac](https://github.com/devicemanager/WhateverGreen/tree/master/Tools/HookMac)?_  
...
Спасибо igork, что заметил это. Также можно использовать плагин Lilu [WhateverGreen](https://github.com/devicemanager/WhateverGreen) для автоматиизации этого процесса.  
  
- _Совместимость с дискретной видеокартой для неподдерживаемых конфигураций (NVIDIA+SNB/SKL/KBL, AMD+IVY)_, для некоторых приложений решается с помощью плагина Lilu [WhateverGreen](https://github.com/devicemanager/WhateverGreen), начиная с macOS 10.13.4 проблема отсутствует.  
...
- _Что делает утилита [BoardHash](https://github.com/devicemanager/WhateverGreen/tree/master/Tools/BoardHash)?_  
...
Для отключения HDCP/PAVP и предотвращения зависаний рекомендуется использовать [WhateverGreen](https://github.com/devicemanager/WhateverGreen).
